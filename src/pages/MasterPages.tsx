...
export function GoodsReceiptsPage() {
  return <MasterCrudPage title="Goods Receipts (GRN)" description="TBL_GOODS_INWARD_GRN_HDR" idPrefix="GRN" fields={[
    ...
    { key: "company", label: "Company (COMPANY_ID)", type: "select", options: ["AgroTanzania Ltd"] },
    { key: "sourceStore", label: "Source Store (SOURCE_STORE_ID)", type: "select", options: ["Dar es Salaam Main Warehouse", "Mbeya Storage Facility"] },
    { key: "grnStore", label: "GRN Store (GRN_STORE_ID)", type: "select", options: ["Dar es Salaam Main Warehouse", "Mbeya Storage Facility"] },
    { key: "grnSource", label: "GRN Source", type: "select", options: ["Purchase Order", "Stock Transfer"] },
    { key: "deliveryNoteRefNo", label: "Delivery Note Ref No", type: "text" },
    { key: "supplier", label: "Supplier (SUPPLIER_ID)", type: "select", options: ["Kilimo Bora Suppliers", "Agro-Inputs Ltd", "Mbeya Rice Mills", "Sun Valley Farms", "Kigoma Pulse Exporters", "Zanzibar Spice Traders"] },
    { key: "poRefNo", label: "PO Reference No", type: "text", required: true },
    { key: "purchaseInvoiceRefNo", label: "Purchase Invoice Ref No", type: "text" },
    { key: "supplierInvoiceNumber", label: "Supplier Invoice Number", type: "text" },
    { key: "containerNo", label: "Container No", type: "text" },
    { key: "driverName", label: "Driver Name", type: "text" },
    { key: "driverContactNumber", label: "Driver Contact Number", type: "text" },
    { key: "vehicleNo", label: "Vehicle No", type: "text" },
    { key: "sealNo", label: "Seal No", type: "text" },
    { key: "remarks", label: "Remarks", type: "textarea" },
    { key: "statusEntry", label: "Status", type: "select", required: true, options: ["Received", "Pending", "Partial", "Rejected"] },
  ]} initialData={[
    { id: "GRN001", grnRefNo: "GRN/MA/02/001", grnDate: "2024-02-10", company: "AgroTanzania Ltd", sourceStore: "Mbeya Storage Facility", grnStore: "Dar es Salaam Main Warehouse", grnSource: "Purchase Order", deliveryNoteRefNo: "", supplier: "Kilimo Bora Suppliers", poRefNo: "PO/MA/02/001", purchaseInvoiceRefNo: "", supplierInvoiceNumber: "SUP-INV-2024-001", containerNo: "CTNU-4401234", driverName: "Juma Ali", driverContactNumber: "+255 789 111222", vehicleNo: "T 123 ABC", sealNo: "SEAL-001", remarks: "Quantity verified: 10,000 KG Maize received", statusEntry: "Received" },
    { id: "GRN002", grnRefNo: "GRN/FE/02/002", grnDate: "2024-02-18", company: "AgroTanzania Ltd", sourceStore: "", grnStore: "Dar es Salaam Main Warehouse", grnSource: "Purchase Order", deliveryNoteRefNo: "", supplier: "Agro-Inputs Ltd", poRefNo: "PO/FE/02/002", purchaseInvoiceRefNo: "", supplierInvoiceNumber: "SUP-INV-2024-002", containerNo: "", driverName: "Bakari Musa", driverContactNumber: "+255 789 222333", vehicleNo: "T 456 DEF", sealNo: "SEAL-002", remarks: "Quality check passed - NPK bags intact", statusEntry: "Received" },
    { id: "GRN003", grnRefNo: "GRN/RI/03/003", grnDate: "2024-03-12", company: "AgroTanzania Ltd", sourceStore: "Mbeya Storage Facility", grnStore: "Dar es Salaam Main Warehouse", grnSource: "Purchase Order", deliveryNoteRefNo: "", supplier: "Mbeya Rice Mills", poRefNo: "PO/RI/03/003", purchaseInvoiceRefNo: "", supplierInvoiceNumber: "", containerNo: "", driverName: "Said Mohamed", driverContactNumber: "+255 789 444555", vehicleNo: "T 789 GHI", sealNo: "", remarks: "Partial delivery - 5,000 KG of 8,000 KG", statusEntry: "Partial" },
  ]} columns={[
    { key: "grnRefNo", label: "GRN No" }, { key: "grnDate", label: "Date" }, { key: "poRefNo", label: "PO Ref" }, { key: "supplier", label: "Supplier" }, { key: "vehicleNo", label: "Vehicle" }, { key: "statusEntry", label: "Status" },
  ]} />;
}

export function PurchaseBookingPage() {
  return <MasterCrudPage title="Purchase Invoices (3-Way Match)" description="TBL_PURCHASE_INVOICE_HDR — Invoice must match PO and GRN" idPrefix="PBI" fields={[
    { key: "purchaseInvoiceRefNo", label: "Purchase Invoice Ref No", type: "text", required: true },
    { key: "company", label: "Company (COMPANY_ID)", type: "select", options: ["AgroTanzania Ltd"] },
    { key: "invoiceNo", label: "Supplier Invoice No (INVOICE_NO)", type: "text", required: true },
    { key: "invoiceDate", label: "Invoice Date", type: "date", required: true },
    { key: "poRefNo", label: "PO Reference No (PO_REF_NO)", type: "text", required: true },
    { key: "purchaseType", label: "Purchase Type", type: "select", options: ["Local Purchase", "Import"] },
    { key: "supplier", label: "Supplier (SUPPLIER_ID)", type: "select", options: ["Kilimo Bora Suppliers", "Agro-Inputs Ltd", "Mbeya Rice Mills", "Sun Valley Farms", "Kigoma Pulse Exporters", "Zanzibar Spice Traders"] },
    { key: "store", label: "Store (STORE_ID)", type: "select", options: ["Dar es Salaam Main Warehouse", "Mbeya Storage Facility"] },
    { key: "paymentTerm", label: "Payment Term (PAYMENT_TERM_ID)", type: "select", options: ["Cash on Delivery", "Net 30 Days", "Net 60 Days", "Advance Payment"] },
    { key: "modeOfPayment", label: "Mode of Payment", type: "select", options: ["Bank Transfer", "Cheque", "Cash", "Mobile Money"] },
    { key: "currency", label: "Currency (CURRENCY_ID)", type: "select", options: ["TZS", "USD", "EUR"] },
    { key: "priceTerms", label: "Price Terms", type: "text" },
    { key: "productHdrAmount", label: "Product Amount (HDR)", type: "number" },
    { key: "totalAdditionalCostAmount", label: "Total Additional Cost", type: "number" },
    { key: "totalProductHdrAmount", label: "Total Product Amount", type: "number" },
    { key: "totalVatHdrAmount", label: "Total VAT Amount", type: "number" },
    { key: "finalInvoiceHdrAmount", label: "Final Invoice Amount", type: "number" },
    { key: "exchangeRate", label: "Exchange Rate", type: "number" },
    { key: "productHdrAmountLC", label: "Product Amount (LC)", type: "number" },
    { key: "totalAdditionalCostAmountLC", label: "Additional Cost (LC)", type: "number" },
    { key: "totalProductHdrAmountLC", label: "Total Product (LC)", type: "number" },
    { key: "totalVatHdrAmountLC", label: "Total VAT (LC)", type: "number" },
    { key: "finalPurchaseInvoiceAmountLC", label: "Final Invoice Amount (LC)", type: "number" },
    { key: "submittedBy", label: "Submitted By", type: "text" },
    { key: "submittedDate", label: "Submitted Date", type: "date" },
    { key: "remarks", label: "Remarks", type: "textarea" },
    { key: "statusEntry", label: "Status", type: "select", required: true, options: ["Draft", "Submitted", "Approved", "Rejected"] },
  ]} initialData={[
    { id: "PBI001", purchaseInvoiceRefNo: "PI/MA/02/001", company: "AgroTanzania Ltd", invoiceNo: "INV-2024-001", invoiceDate: "2024-02-15", poRefNo: "PO/MA/02/001", purchaseType: "Local Purchase", supplier: "Kilimo Bora Suppliers", store: "Dar es Salaam Main Warehouse", paymentTerm: "Net 30 Days", modeOfPayment: "Bank Transfer", currency: "USD", priceTerms: "FOB", productHdrAmount: 50000, totalAdditionalCostAmount: 2500, totalProductHdrAmount: 52500, totalVatHdrAmount: 4730, finalInvoiceHdrAmount: 57230, exchangeRate: 2650, productHdrAmountLC: 132500000, totalAdditionalCostAmountLC: 6625000, totalProductHdrAmountLC: 139125000, totalVatHdrAmountLC: 12534500, finalPurchaseInvoiceAmountLC: 151659500, submittedBy: "sarah.kimani", submittedDate: "2024-02-15", remarks: "3-way match verified: PO/MA/02/001 + GRN/MA/02/001", statusEntry: "Approved" },
    { id: "PBI002", purchaseInvoiceRefNo: "PI/FE/02/002", company: "AgroTanzania Ltd", invoiceNo: "INV-2024-002", invoiceDate: "2024-02-22", poRefNo: "PO/FE/02/002", purchaseType: "Local Purchase", supplier: "Agro-Inputs Ltd", store: "Dar es Salaam Main Warehouse", paymentTerm: "Net 30 Days", modeOfPayment: "Bank Transfer", currency: "USD", priceTerms: "CIF", productHdrAmount: 30000, totalAdditionalCostAmount: 1800, totalProductHdrAmount: 31800, totalVatHdrAmount: 3600, finalInvoiceHdrAmount: 35400, exchangeRate: 2650, productHdrAmountLC: 79500000, totalAdditionalCostAmountLC: 4770000, totalProductHdrAmountLC: 84270000, totalVatHdrAmountLC: 9540000, finalPurchaseInvoiceAmountLC: 93810000, submittedBy: "sarah.kimani", submittedDate: "2024-02-22", remarks: "3-way match verified", statusEntry: "Approved" },
  ]} columns={[
    { key: "purchaseInvoiceRefNo", label: "Invoice Ref" }, { key: "invoiceNo", label: "Supplier Inv" }, { key: "poRefNo", label: "PO Ref" }, { key: "supplier", label: "Supplier" }, { key: "finalInvoiceHdrAmount", label: "Amount" }, { key: "statusEntry", label: "Status" },
  ]} />;
}
...
export function ExpensesPage() {
  return <MasterCrudPage title="Expenses" description="TBL_EXPENSE_HDR — All expenses must have TRA EFD receipts and be linked to PO reference" idPrefix="EXP" fields={[
    ...
    { key: "poRefNo", label: "PO Reference (PO_REF_NO)", type: "text", required: true },
    { key: "accountHead", label: "Account Head (ACCOUNT_HEAD_ID)", type: "select", required: true, options: ["Transportation", "Loading/Offloading", "Accommodation", "Travel Expenses", "Fines & Penalties", "Miscellaneous"] },
    { key: "expenseSupplier", label: "Expense Supplier (EXPENSE_SUPPLIER_ID)", type: "select", options: ["Speedy Logistics", "Local Labour Co", "Safari Inn Hotels", "Trans Africa Shipping"] },
    ...
    { key: "submittedDate", label: "Submitted Date", type: "date" },
    { key: "remarks", label: "Remarks", type: "textarea" },
    { key: "statusEntry", label: "Status", type: "select", required: true, options: ["Pending", "Approved", "Rejected"] },
  ]} initialData={[
    { id: "EXP001", expenseRefNo: "EXP/MA/02/001", expenseDate: "2024-02-12", company: "AgroTanzania Ltd", expenseAgainst: "Purchase Order", poRefNo: "PO/MA/02/001", accountHead: "Transportation", expenseSupplier: "Speedy Logistics", expenseType: "Road Transport", traEfdReceiptNo: "EFD-2024-001234", currency: "USD", exchangeRate: 2650, totalExpenseAmount: 1800, totalExpenseAmountLC: 4770000, submittedBy: "sarah.kimani", submittedDate: "2024-02-12", remarks: "Transport from Mbeya to DSM", statusEntry: "Approved" },
    { id: "EXP002", expenseRefNo: "EXP/MA/02/002", expenseDate: "2024-02-12", company: "AgroTanzania Ltd", expenseAgainst: "Purchase Order", poRefNo: "PO/MA/02/001", accountHead: "Loading/Offloading", expenseSupplier: "Local Labour Co", expenseType: "Loading at warehouse", traEfdReceiptNo: "EFD-2024-001235", currency: "USD", exchangeRate: 2650, totalExpenseAmount: 500, totalExpenseAmountLC: 1325000, submittedBy: "sarah.kimani", submittedDate: "2024-02-12", remarks: "", statusEntry: "Approved" },
    { id: "EXP003", expenseRefNo: "EXP/MA/02/003", expenseDate: "2024-02-13", company: "AgroTanzania Ltd", expenseAgainst: "Purchase Order", poRefNo: "PO/MA/02/001", accountHead: "Accommodation", expenseSupplier: "Safari Inn Hotels", expenseType: "Hotel stay during procurement trip", traEfdReceiptNo: "EFD-2024-001240", currency: "TZS", exchangeRate: 1, totalExpenseAmount: 150000, totalExpenseAmountLC: 150000, submittedBy: "sarah.kimani", submittedDate: "2024-02-13", remarks: "2 nights accommodation", statusEntry: "Approved" },
    { id: "EXP004", expenseRefNo: "EXP/FE/02/004", expenseDate: "2024-02-20", company: "AgroTanzania Ltd", expenseAgainst: "Purchase Order", poRefNo: "PO/FE/02/002", accountHead: "Transportation", expenseSupplier: "Speedy Logistics", expenseType: "Transport fertilizer", traEfdReceiptNo: "EFD-2024-001280", currency: "USD", exchangeRate: 2650, totalExpenseAmount: 1200, totalExpenseAmountLC: 3180000, submittedBy: "sarah.kimani", submittedDate: "2024-02-20", remarks: "", statusEntry: "Approved" },
  ]} columns={[
    { key: "expenseRefNo", label: "Ref No" }, { key: "accountHead", label: "Account Head" }, { key: "poRefNo", label: "PO Ref" }, { key: "totalExpenseAmount", label: "Amount" }, { key: "traEfdReceiptNo", label: "EFD Receipt" }, { key: "statusEntry", label: "Status" },
  ]} />;
}
...
export function SalesOrdersPage() {
  return <MasterCrudPage title="Sales Orders" description="TBL_SALES_ORDER_HDR" idPrefix="SO" fields={[
    ...
    { key: "company", label: "Company (COMPANY_ID)", type: "select", options: ["AgroTanzania Ltd"] },
    { key: "store", label: "Store (STORE_ID)", type: "select", options: ["Dar es Salaam Main Warehouse", "Mbeya Storage Facility"] },
    { key: "customer", label: "Customer (CUSTOMER_ID)", type: "text", required: true },
    { key: "billingLocation", label: "Billing Location (BILLING_LOCATION_ID)", type: "select", options: ["Dar es Salaam HQ", "Arusha Office"] },
    { key: "salesPerson", label: "Sales Person (SALES_PERSON_EMP_ID)", type: "select", options: ["James Kileo", "Grace Mwangi"] },
    ...
    { key: "totalProductAmountLC", label: "Product Amount (LC)", type: "number" },
    { key: "finalSalesAmountLC", label: "Final Amount (LC)", type: "number" },
    { key: "submittedBy", label: "Submitted By", type: "text" },
    { key: "submittedDate", label: "Submitted Date", type: "date" },
    { key: "remarks", label: "Remarks", type: "textarea" },
    { key: "statusEntry", label: "Status", type: "select", required: true, options: ["Draft", "Confirmed", "Delivered", "Invoiced", "Cancelled"] },
  ]} initialData={[
    { id: "SO001", salesOrderRefNo: "SO/03/001", salesOrderDate: "2024-03-01", company: "AgroTanzania Ltd", store: "Dar es Salaam Main Warehouse", customer: "Metro Foods Inc (TIN: 123-456-789)", billingLocation: "Dar es Salaam HQ", salesPerson: "James Kileo", creditLimitAmount: 500000, creditLimitDays: 30, outstandingAmount: 0, currency: "TZS", exchangeRate: 1, totalProductAmount: 7900000, vatAmount: 1422000, finalSalesAmount: 9322000, totalProductAmountLC: 7900000, finalSalesAmountLC: 9322000, submittedBy: "james.kileo", submittedDate: "2024-03-01", remarks: "", statusEntry: "Delivered" },
    { id: "SO002", salesOrderRefNo: "SO/03/002", salesOrderDate: "2024-03-05", company: "AgroTanzania Ltd", store: "Dar es Salaam Main Warehouse", customer: "Coastal Traders Ltd (TIN: 987-654-321)", billingLocation: "Dar es Salaam HQ", salesPerson: "James Kileo", creditLimitAmount: 300000, creditLimitDays: 15, outstandingAmount: 150000, currency: "TZS", exchangeRate: 1, totalProductAmount: 4500000, vatAmount: 810000, finalSalesAmount: 5310000, totalProductAmountLC: 4500000, finalSalesAmountLC: 5310000, submittedBy: "james.kileo", submittedDate: "2024-03-05", remarks: "", statusEntry: "Confirmed" },
  ]} columns={[
    { key: "salesOrderRefNo", label: "SO No" }, { key: "salesOrderDate", label: "Date" }, { key: "customer", label: "Customer" }, { key: "finalSalesAmount", label: "Amount" }, { key: "salesPerson", label: "Sales Person" }, { key: "statusEntry", label: "Status" },
  ]} />;
}
...
export function DeliveryNotesPage() {
  return <MasterCrudPage title="Delivery Notes" description="TBL_DELIVERY_NOTE_HDR" idPrefix="DN" fields={[
    ...
    { key: "company", label: "Company (COMPANY_ID)", type: "select", options: ["AgroTanzania Ltd"] },
    { key: "fromStore", label: "From Store (FROM_STORE_ID)", type: "select", options: ["Dar es Salaam Main Warehouse", "Mbeya Storage Facility"] },
    { key: "deliverySourceType", label: "Delivery Source Type", type: "select", options: ["Sales Order", "Stock Transfer"] },
    { key: "deliverySourceRefNo", label: "Source Ref No (SO/Transfer)", type: "text" },
    { key: "toStore", label: "To Store (TO_STORE_ID)", type: "select", options: ["Dar es Salaam Main Warehouse", "Mbeya Storage Facility", "Customer Location"] },
    { key: "customer", label: "Customer (CUSTOMER_ID)", type: "text" },
    ...
    { key: "submittedDate", label: "Submitted Date", type: "date" },
    { key: "remarks", label: "Remarks", type: "textarea" },
    { key: "statusEntry", label: "Status", type: "select", required: true, options: ["Pending", "Dispatched", "In Transit", "Delivered"] },
  ]} initialData={[
    { id: "DN001", deliveryNoteRefNo: "DN/03/001", deliveryDate: "2024-03-15", company: "AgroTanzania Ltd", fromStore: "Dar es Salaam Main Warehouse", deliverySourceType: "Sales Order", deliverySourceRefNo: "SO/03/001", toStore: "Customer Location", customer: "Metro Foods Inc", truckNo: "T 456 DEF", trailerNo: "TR-001", driverName: "Hassan Juma", driverContactNumber: "+255 789 333444", sealNo: "SEAL-S001", currency: "TZS", exchangeRate: 1, totalProductAmount: 7900000, vatAmount: 1422000, finalSalesAmount: 9322000, totalProductAmountLC: 7900000, finalSalesAmountLC: 9322000, submittedBy: "james.kileo", submittedDate: "2024-03-15", remarks: "Delivered to Metro Foods warehouse", statusEntry: "Delivered" },
  ]} columns={[
    { key: "deliveryNoteRefNo", label: "DN No" }, { key: "deliveryDate", label: "Date" }, { key: "deliverySourceRefNo", label: "SO Ref" }, { key: "customer", label: "Customer" }, { key: "truckNo", label: "Truck" }, { key: "statusEntry", label: "Status" },
  ]} />;
}
...
export function SalesInvoicesPage() {
  return <MasterCrudPage title="Sales Invoices (Tax Invoice)" description="TBL_TAX_INVOICE_HDR" idPrefix="INV" fields={[
    ...
    { key: "deliveryNoteRefNo", label: "Delivery Note Ref (DN)", type: "text" },
    { key: "customer", label: "Customer (CUSTOMER_ID)", type: "text", required: true },
    { key: "currency", label: "Currency (CURRENCY_ID)", type: "select", options: ["TZS", "USD", "EUR"] },
    { key: "exchangeRate", label: "Exchange Rate", type: "number" },
    { key: "totalProductAmount", label: "Total Product Amount", type: "number" },
    ...
    { key: "submittedDate", label: "Submitted Date", type: "date" },
    { key: "remarks", label: "Remarks", type: "textarea" },
    { key: "statusEntry", label: "Status", type: "select", required: true, options: ["Draft", "Sent", "Paid", "Overdue", "Cancelled"] },
  ]} initialData={[
    { id: "INV001", taxInvoiceRefNo: "SI/03/001", invoiceDate: "2024-03-16", company: "AgroTanzania Ltd", fromStore: "Dar es Salaam Main Warehouse", invoiceType: "Tax Invoice", deliveryNoteRefNo: "DN/03/001", customer: "Metro Foods Inc (TIN: 123-456-789, Dar es Salaam)", currency: "TZS", exchangeRate: 1, totalProductAmount: 7900000, vatAmount: 1422000, finalSalesAmount: 9322000, totalProductAmountLC: 7900000, finalSalesAmountLC: 9322000, submittedBy: "james.kileo", submittedDate: "2024-03-16", remarks: "", statusEntry: "Paid" },
  ]} columns={[
    { key: "taxInvoiceRefNo", label: "Invoice" }, { key: "invoiceDate", label: "Date" }, { key: "customer", label: "Customer" }, { key: "finalSalesAmount", label: "Amount" }, { key: "invoiceType", label: "Type" }, { key: "statusEntry", label: "Status" },
  ]} />;
}
...
export function CustomerReceiptsPage() {
  return <MasterCrudPage title="Customer Receipts" description="TBL_CUSTOMER_RECEIPT_HDR" idPrefix="CR" fields={[
    ...
    { key: "company", label: "Company (COMPANY_ID)", type: "select", options: ["AgroTanzania Ltd"] },
    { key: "customer", label: "Customer (CUSTOMER_ID)", type: "text", required: true },
    { key: "paymentMode", label: "Payment Mode (PAYMENT_MODE_ID)", type: "select", options: ["Bank Transfer", "Cheque", "Cash", "Mobile Money"] },
    { key: "crBankCash", label: "CR Bank/Cash (CR_BANK_CASH_ID)", type: "select", options: ["CRDB Bank", "NMB Bank", "Stanbic Bank", "Cash"] },
    { key: "crAccount", label: "CR Account (CR_ACCOUNT_ID)", type: "select", options: ["0150-123456789", "2200-987654321"] },
    { key: "drBankCash", label: "DR Bank/Cash (DR_BANK_CASH_ID)", type: "select", options: ["CRDB Bank", "NMB Bank", "Stanbic Bank", "Cash"] },
    ...
    { key: "exchangeRate", label: "Exchange Rate", type: "number" },
    { key: "receiptAmountLC", label: "Receipt Amount (LC)", type: "number" },
    { key: "tallyRefNo", label: "Tally Ref No", type: "text" },
    { key: "tallySyncStatus", label: "Tally Sync Status", type: "select", options: ["Synced", "Pending", "Failed"] },
    { key: "submittedBy", label: "Submitted By", type: "text" },
    { key: "submittedDate", label: "Submitted Date", type: "date" },
    { key: "remarks", label: "Remarks", type: "textarea" },
    { key: "statusEntry", label: "Status", type: "select", required: true, options: ["Draft", "Submitted", "Approved", "Rejected"] },
  ]} initialData={[
    { id: "CR001", receiptRefNo: "CR/03/001", receiptDate: "2024-03-20", paymentType: "Full Payment", company: "AgroTanzania Ltd", customer: "Metro Foods Inc", paymentMode: "Bank Transfer", crBankCash: "CRDB Bank", crAccount: "0150-123456789", drBankCash: "NMB Bank", transactionRefNo: "TXN-2024-001", transactionDate: "2024-03-20", currency: "TZS", receiptAmount: 9322000, exchangeRate: 1, receiptAmountLC: 9322000, tallyRefNo: "TALLY-CR-001", tallySyncStatus: "Synced", submittedBy: "james.kileo", submittedDate: "2024-03-20", remarks: "Full payment for SI/03/001", statusEntry: "Approved" },
    { id: "CR002", receiptRefNo: "CR/03/002", receiptDate: "2024-03-22", paymentType: "Partial Payment", company: "AgroTanzania Ltd", customer: "Coastal Traders Ltd", paymentMode: "Mobile Money", crBankCash: "Cash", crAccount: "", drBankCash: "", transactionRefNo: "MPESA-2024-5678", transactionDate: "2024-03-22", currency: "TZS", receiptAmount: 2000000, exchangeRate: 1, receiptAmountLC: 2000000, tallyRefNo: "", tallySyncStatus: "Pending", submittedBy: "james.kileo", submittedDate: "2024-03-22", remarks: "Partial against SO/03/002", statusEntry: "Submitted" },
  ]} columns={[
    { key: "receiptRefNo", label: "Receipt No" }, { key: "receiptDate", label: "Date" }, { key: "customer", label: "Customer" }, { key: "receiptAmount", label: "Amount" }, { key: "paymentMode", label: "Mode" }, { key: "statusEntry", label: "Status" },
  ]} />;
}
